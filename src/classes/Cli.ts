...
class Cli {
  ...
  createTruck(): void {
    inquirer
      ...
      .then((answers) => {
        const wheels: Wheel[] = [new Wheel(), new Wheel(), new Wheel(), new Wheel()];
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (answers.action === 'Print details') {
          ...
          if (selectedVehicle instanceof Truck) {
            // Call findVehicleToTow method to select a vehicle to tow and pass the selected truck as an argument
            this.findVehicleToTow(selectedVehicle);
            return; 
          } else {
            console.log("Only a truck can tow vehicles.");
            this.performActions();  
            return;
          }
